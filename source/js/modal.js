...
const surname = reviewForm.querySelector(".field__surname");
const firstName = reviewForm.querySelector(".field__name");
const telephone = reviewForm.querySelector(".field__phone");
const mail = reviewForm.querySelector(".field__mail");
